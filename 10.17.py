...
# Creates ItemToPurchase class and attributes with defaults
class ItemToPurchase:
    ...
    def print_item_cost(self):
        # Defines output of print_item_cost
        print(self.item_name + " " + str(self.item_quantity) + " @ $"
              + str(self.item_price) + " = $" + str(self.item_price * self.item_quantity))


if __name__ == "__main__":
    # Adds item 1 and item2 to class  ItemsToPurchase
    item1 = ItemToPurchase()

    item2 = ItemToPurchase()

    # Prints item's name and allows input of attributes.
    print("Item 1")
