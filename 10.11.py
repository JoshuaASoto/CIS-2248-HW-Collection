...
class FoodItem:
    ...
    # Defines food attributes( name, fat, carbs, protein)
    ...
    def print_info(self):
        # Defines summary of item information
...
if __name__ == "__main__":
    ...
    print(
        'Number of calories for {:.2f} serving(s): {:.2f}'.format(num_servings,
